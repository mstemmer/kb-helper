...
# ```{r}
# gunzip("~/cellranger_data/DR_20190226_pretectum_s1/outs/raw_feature_bc_matrix/features.tsv.gz", remove = FALSE, overwrite = TRUE)
# table <- read.table(file = "~/cellranger_data/DR_20190226_pretectum_s1/outs/raw_feature_bc_matrix/features.tsv", header = FALSE, sep = "\t")
# table[2]
# ```
